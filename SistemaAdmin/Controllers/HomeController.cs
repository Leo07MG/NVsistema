...
namespace SistemaAdmin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public FileResult ExportarVenta(string fechainicio, string fechafin, string idtransaccion)
        {
            ...
            dt.Columns.Add("Cantidd", typeof(int));
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    return File(stream.ToArray(), "application/vnd.openxmlformats-officedocuments.spreadsheetml.sheet", "ReporteVenta" + DateTime.Now.ToString() + ".xlsx");
